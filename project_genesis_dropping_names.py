...
## Krishanu's Code
# Drop the "Client Name" column (contains initials/names)
df.drop(columns=['Client Name'], inplace=True)

# Insert the new "ID" column in place of "Client Name" (second column position)
